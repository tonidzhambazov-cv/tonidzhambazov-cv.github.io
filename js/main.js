        ...
        a(["#about .pricing-section .single-plan", null], [{
            ...
            e("#resume .skills-section .single-skill").each((function() {
                var a = Math.min(100, Math.max(0, e(this).data("percentage"))),
                    ...
                    i = t - t * (a / 100);
                e(this).find(".skill-percentage").text(a + "%").css("margin-right", i).css("visibility", "hidden"), e(this).find(".progress-bar").attr("aria-valuenow", a).css("width", a + "%")
            }))
            ...
            a.preventDefault(), i.html("Wait...").addClass("wait").prop("disabled", !0), setTimeout((function() {
                e.ajax({
					...
					var check = e.substr(e.lastIndexOf("\n")+1);
                    "1" == check ? (i.removeClass("wait").html("Success").addClass("success"), o.addClass("success").html("Thank you for your message. It has been sent.").fadeIn(200), setTimeout((function() {
                        i.html(s).removeClass("success").prop("disabled", !1), o.fadeOut(200).removeClass("success").html("")
                    }), 6e3), t[0].reset()) : (console.log(check), i.removeClass("wait").html("Error").addClass("error"), o.addClass("error").html("Server error!").fadeIn(200), setTimeout((function() {
